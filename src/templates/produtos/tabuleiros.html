...
<html lang="pt-BR">
    ...
    <head>
        <meta charset="utf-8" />
        <title>ChessGate - Tabuleiros</title>
        <link rel="shortcut icon" href="../../../assets/images/icons/logo_icone.svg" type="image/svg" />
        <meta name="description" content="Compre seu próximo tabuleiro de xadrez na ChessGate!" />
        <meta name="keywords" content="xadrez loja tabuleiro peças shop store" />
        ...
        <div class="container-fluid px-0">
            ...
            <main>
                <div id="conteudo" class="prod">
                    <p style="text-align: center;">Tabuleiros</p>
                    <div id="pri_col">
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title">Tabuleiro Egípcio</h5>
                                <img src="../../../assets/images/products/Tabuleiros/tabuleiro_egipcio.jpg" type="image/jpg" alt="Tabuleiro Egípcio" />
                                <p class="card-text">Lute nas areias do deserto</p>
                                <a href="tabuleiros/tabuleiro_egipcio.html" class="btn">Ver produto</a>
                            </div>
                        </div>
                    </div>
                    <div id="seg_col">
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title">Tabuleiro Oriental</h5>
                                <img src="../../../assets/images/products/Tabuleiros/tabuleiro_oriental.jpg" type="image/jpg" alt="Tabuleiro Oriental" />
                                <p class="card-text">As 64 casas do leste</p>
                                <a href="tabuleiros/tabuleiro_oriental.html" class="btn">Ver produto</a>
                            </div>
                        </div>
                    </div>
                    <div id="ter_col">
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title">Tabuleiro Clássico</h5>
                                <img src="../../../assets/images/products/Tabuleiros/tabuleiro_madeira.jpg" type="image/jpg" alt="Tabuleiro Clássico" />
                                <p class="card-text">O clássico nunca fica velho</p>
                                <a href="tabuleiros/tabuleiro_classico.html" class="btn">Ver produto</a>
                            </div>
                        </div>
                    </div>
                    <div id="qua_col">
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title">Tabuleiro Medieval</h5>
                                <img src="../../../assets/images/products/Tabuleiros/tabuleiro_medieval.webp" type="image/webp" alt="Tabuleiro Medieval" />
                                <p class="card-text">Batalhe entre reinos</p>
                                <a href="tabuleiros/tabuleiro_medieval.html" class="btn">Ver produto</a>
                            </div>
                        </div>
                    </div>
                    <div id="qui_col">
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title">Tabuleiro Magnético</h5>
                                <img src="../../../assets/images/products/Tabuleiros/tabuleiro_magnetico.webp" type="image/webp" alt="Tabuleiro Magnético" />
                                <p class="card-text">Leve-o para onde for</p>
                                <a href="tabuleiros/tabuleiro_magnetico.html" class="btn">Ver produto</a>
                            </div>
                        </div>
                    </div>
                </div>
